...
function renderUsers(usersArray) {
  ...
  if (usersArray && usersArray.length) {
    ...
    usersArray.forEach((user) => {
      ...
      edit.innerText = "რედაქტირება";
      edit.setAttribute("data-user-id", user.id);
	  remove.setAttribute("data-user-id", user.id);
      remove.innerText = "წაშლა";
